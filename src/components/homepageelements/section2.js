...
const Section2 = () => {
    ...
    const offerPost1Img = wpPage.frontPage.section2.featuredPost1.featuredImage.node.sourceUrl
    ...
    const offerPost2Img = wpPage.frontPage.section2.featuredPost2.featuredImage.node.sourceUrl
    ...
    const offerPost3Img = wpPage.frontPage.section2.featuredPost3.featuredImage.node.sourceUrl
    ...
    const buttonTravelExperience = wpPage.frontPage.section2.buttonTravelExperience
    const travelExperienceImage = wpPage.frontPage.section2.travelExperienceImage.sourceUrl
